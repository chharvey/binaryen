...
export class CallIndirect extends Expression {
	...
	get params(): Type { return BinaryenObj["_BinaryenCallIndirectGetParams"](this._ptr) as Type; }
	set params(params: Type) { BinaryenObj["_BinaryenCallIndirectSetParams"](this._ptr, params); }

	get results(): Type { return BinaryenObj["_BinaryenCallIndirectGetResults"](this._ptr) as Type; }
